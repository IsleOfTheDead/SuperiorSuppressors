class ReinforceSuppressor extends RecipeBase
{
	override void Init()
	{
		m_Name = "#STR_ReinforceSuppressor0";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"ImprovisedSuppressor");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("ReinforcedSuppressor");//add results here
